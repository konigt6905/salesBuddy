  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-20 pb-8 px-4 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto text-center z-10">
        ...
        {/* Subheadline */}
        <p className="text-lg sm:text-xl text-gray-400 max-w-3xl mx-auto mb-10 animate-fade-in-up" style={{ animationDelay: '200ms' }}>
          Stop drowning in spreadsheets. Sales Buddy transforms your raw CRM data into clear,
          actionable visual insights. Predict trends, spot risks, and close deals faster with 98% accuracy.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12 animate-fade-in-up" style={{ animationDelay: '300ms' }}>
          <button
            ...
            className="group px-8 py-4 rounded-lg bg-gradient-to-r from-blue-500 to-cyan-500 text-white font-semibold text-lg shadow-lg shadow-blue-500/40 hover:shadow-blue-500/60 transition-all hover:scale-105 flex items-center gap-2"
          >
            Start Free Trial
        ...
        {/* Trust indicators */}
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 text-sm text-gray-500 animate-fade-in-up" style={{ animationDelay: '400ms' }}>
        ...
        <div className="mt-16 pb-8 relative animate-fade-in-up" style={{ animationDelay: '500ms' }}>
          {/* Glow effect behind dashboard */}
          <div className="absolute inset-0 bg-gradient-to-r from-blue-500/10 via-cyan-500/15 to-blue-500/10 blur-3xl scale-110" />

          <div className="relative glass-card rounded-2xl p-4 sm:p-6 max-w-5xl mx-auto border-cyan-500/20 shadow-2xl shadow-cyan-500/10">
            ...
            <div className="flex items-center justify-between mb-5">
              <div className="flex items-center gap-4">
                ...
                <div className="relative">
                  <div className="w-12 h-12 rounded-full bg-gradient-to-br from-cyan-400 via-blue-500 to-cyan-400 flex items-center justify-center animate-pulse-glow">
                  ...
                  {/* Orbital ring */}
                  <div
                    className="absolute inset-[-4px] rounded-full border-2 border-cyan-400/30 border-dashed"
                ...
                <div>
                  <div className="flex items-center gap-2">
                    <p className="text-white font-semibold text-lg">Sales Buddy</p>
                    <span className="px-2 py-0.5 rounded-full bg-cyan-500/20 border border-cyan-500/30 text-cyan-400 text-xs font-medium animate-pulse">
                      AI Active
                    </span>
                  </div>
                  <p className="text-gray-500 text-sm">Live data - Updated 2s ago</p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-5">
              {stats.map((stat, index) => (
                <div
                  key={stat.label}
                  className="relative bg-white/5 rounded-xl p-3 sm:p-4 border border-white/10 overflow-hidden group hover:border-cyan-500/30 transition-all duration-300"
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-lg sm:text-xl font-bold text-white mb-2">{stat.value}</p>

                    {/* Mini Sparkline SVG */}
                    <svg className="w-full h-6" viewBox="0 0 100 32" preserveAspectRatio="none">
                      <defs>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
              ...
              <div className="lg:col-span-5 space-y-2">
                ...
                {deals.map((deal, index) => (
                  <div
                    key={deal.name}
                    className="flex items-center gap-3 p-3 rounded-xl bg-white/5 border border-white/5 hover:border-cyan-500/20 hover:bg-white/[0.07] transition-all duration-300"
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between">
                        ...
                        <p className="text-white text-sm font-semibold">{deal.value}</p>
                      </div>
                      <div className="flex items-center justify-between mt-0.5">
                        <span className="text-gray-500 text-xs">{deal.stage}</span>
              ...
              <div className="lg:col-span-3">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="text-white text-sm font-semibold">Pipeline</h3>
                </div>
                ...
                <div className="space-y-1.5">
                  {pipelineStages.map((stage, index) => (
                    <div key={stage.stage} className="relative group">
                      <div
                        className={`h-7 rounded-lg bg-gradient-to-r ${stage.color} flex items-center justify-between px-2.5 transition-all duration-500 group-hover:shadow-lg group-hover:shadow-cyan-500/20`}
                        style={{
                          width: stage.width,
                      ...
                      >
                        ...
                        <span className="text-white/90 text-xs font-bold">{stage.count}</span>
                      </div>
                    </div>
                  ))}
                </div>
                ...
                <div className="mt-3 pt-2 border-t border-white/10 flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-1">
                    <TrendingUp className="w-3 h-3 text-green-400" />
                    <span className="text-green-400 text-sm font-bold">14.5%</span>
                  </div>
                </div>
              </div>
              ...
              <div className="lg:col-span-4 space-y-3">
                ...
                <div className="p-3 rounded-xl bg-gradient-to-br from-cyan-500/15 to-blue-500/10 border border-cyan-500/30 relative overflow-hidden">
                  {/* Shimmer effect */}
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/5 to-transparent -translate-x-full animate-shimmer" />

                  <div className="flex items-start gap-2 relative z-10">
                    <div className="w-7 h-7 rounded-full bg-gradient-to-br from-cyan-400 to-blue-500 flex items-center justify-center flex-shrink-0 animate-pulse-glow">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300 text-xs leading-relaxed">
                        "Acme Corp engagement is up 40% this week. Schedule a follow-up call to close."
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-2">
                    {activities.map((activity, index) => (
                      ...
                      >
                        ...
                        <span className="text-gray-600 text-[10px]">{activity.time}</span>
                      </div>
                    ))}
                  </div>
                </div>
